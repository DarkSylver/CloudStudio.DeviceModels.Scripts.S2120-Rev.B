...
# Parsing + Configuration Script – S2120 - Rev. B

This **Parsing + Configuration** script is designed for the **S2120** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – S2120 Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **S2120** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
